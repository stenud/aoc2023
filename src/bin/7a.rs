...
impl Hand {
    ...
    fn fields_as_array(&self) -> [u32; 13] {
        [self.card_2.clone(), self.card_3.clone(), self.card_4.clone(), self.card_5.clone(), self.card_6.clone(),
         self.card_7.clone(), self.card_8.clone(), self.card_9.clone(), self.card_t.clone(), self.card_j.clone(),
